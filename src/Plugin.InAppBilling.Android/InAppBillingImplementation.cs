...
namespace Plugin.InAppBilling
{
	...
	public class InAppBillingImplementation : BaseInAppBilling
	{
		...
		const string EXTRA_SUB_PARAM_REPLACE_SKUS_PRORATION = "replaceSkusProration";
		...
		public async override Task<InAppBillingPurchase> UpgradePurchasedSubscriptionAsync(string oldProductId, string newProductId, string payload, IInAppBillingVerifyPurchase verifyPurchase = null, bool prorate = true)
		{
			...
			Purchase purchase = await UpgradePurchasedSubscriptionInternalAsync(oldProductId, newProductId, payload, verifyPurchase, prorate);
		...
		async Task<Purchase> UpgradePurchasedSubscriptionInternalAsync(string oldProductId, string newProductId, string payload, IInAppBillingVerifyPurchase verifyPurchase = null, bool prorate = true)
		{
			...
			lock (purchaseLocker)
			{
				...
				extraParams.PutBoolean(EXTRA_SUB_PARAM_REPLACE_SKUS_PRORATION, prorate);
